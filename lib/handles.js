...
// Category wise Moderator
var categoryModeratorPage = handle.compile(fs.readFileSync(path.join(_PUBLIC, "post_categorywise_moderator.html")).toString());
// Sign up
var signUpPage = handle.compile(fs.readFileSync(path.join(_PUBLIC, "signup_form.html")).toString());
// Analytics
var analyticsPage = handle.compile(fs.readFileSync(path.join(_PUBLIC, "analytics.html")).toString());
// Error page
var errorPage = handle.compile(fs.readFileSync(path.join(_PUBLIC, "error.html")).toString());
...
module.exports.categoryModeratorPage = categoryModeratorPage;
